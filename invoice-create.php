		...
		<form method="post" id="create_invoice">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					<div class="row">
						<div class="col-xs-6">
							<h2 class="">Seleccionar Tipo:</h2>
						</div>
						<div class="col-xs-3">
							<select name="invoice_type" id="invoice_type" class="form-control">
								<option value="invoice" selected>Orden Trabajo</option>
					...
					<div class="col-xs-4 no-padding-right">
				        <div class="form-group">
				            <div class="input-group date" id="invoice_date">
				                <input type="text" class="form-control required" name="invoice_date" placeholder="Fecha OT" data-date-format="<?php echo DATE_FORMAT ?>" />
				    ...
				    <div class="col-xs-4">
				        <div class="form-group">
				            <div class="input-group date" id="invoice_due_date">
				                <input type="text" class="form-control required" name="invoice_due_date" placeholder="Fecha entrega" data-date-format="<?php echo DATE_FORMAT ?>" />
				                <span class="input-group-addon">
				                    <span class="glyphicon glyphicon-calendar"></span>
				                </span>
				            </div>
					...
					<div class="input-group col-xs-4 float-right">
						...
						<input type="text" name="invoice_id" id="invoice_id" class="form-control required" placeholder="CAI" aria-describedby="sizing-addon1" value="<?php getInvoiceId(); ?>">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="float-left">Información del cliente</h4>
							<a href="#" class="float-right select-customer"><b>O</b> Seleccionar cliente existente</a>
							<div class="clear"></div>
						</div>
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								...
								<div class="col-xs-6">
								    ...
								    <div class="form-group no-margin-bottom">
								    	<input type="text" class="form-control required" name="customer_phone" id="customer_phone" placeholder="Teléfono" tabindex="8">
									</div>
								</div>
							</div>
						</div>
			...
			<table class="table table-bordered table-hover table-striped" id="invoice_table">
				<thead>
					<tr>
						<th width="500">
							<h4><a href="#" class="btn btn-success btn-xs add-row"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a> Productos</h4>
						</th>
						<th>
							<h4>Cant</h4>
						</th>
					...
					<tr>
						<td>
							<div class="form-group form-group-sm  no-margin-bottom">
								...
								<input type="text" class="form-control form-group-sm item-input invoice_product" name="invoice_product[]" placeholder="Ingrese el nombre del producto">
								<p class="item-select">O <a href="#">Seleccione un producto</a></p>
							</div>
						</td>
						<td class="text-right">
							<div class="form-group form-group-sm no-margin-bottom">
						...
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate" name="invoice_product_discount[]" placeholder="Ingrese % O valor (ej: 10% or 10.50)">
							</div>
						</td>
						<td class="text-right">
			...
			<div id="invoice_totals" class="padding-right row text-right">
				<div class="col-xs-6">
					<div class="input-group form-group-sm textarea no-margin-bottom">
						<textarea class-"form-control" name="invoice_notes" placeholder="Comentarios..."></textarea>
					</div>
				...
				<div class="col-xs-6 no-padding-right">
					...
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
							<strong class="shipping">Envío:</strong>
						</div>
						<div class="col-xs-3">
							<div class="input-group input-group-sm">
								<span class="input-group-addon"><?php echo CURRENCY ?></span>
					...
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
							<strong>Impuesto:</strong><br>Remover Impuesto <input type="checkbox" class="remove_vat">
						</div>
						<div class="col-xs-3">
					...
					<div class="col-xs-6">
						<input type="email" name="custom_email" id="custom_email" class="custom_email_textarea" placeholder="Enter custom email.."></input>
					</div>

					<div class="col-xs-6 margin-top btn-group">
						<input type="submit" id="action_create_invoice" class="btn btn-success float-right" value="Crear OT" data-loading-text="Creando...">
					</div>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        <button type="button" data-dismiss="modal" class="btn btn-primary" id="selected">Añadir</button>
